...
| COM_MAX_R                                                    |            -1.0 |            None |            None | maximum radius for determining center of mass (<0=auto -> __FLT_MAX__) [-1.0] |
...
| EXT_POT_TABLE_EDGEL_X                                        |            None |            None |            None | ... : starting x/y/z coordinates |
| EXT_POT_TABLE_EDGEL_Y                                        |            None |            None |            None |  |
| EXT_POT_TABLE_EDGEL_Z                                        |            None |            None |            None |  |
...
| EXT_POT_TABLE_NPOINT_X                                       |              -1 |            None |            None | ... : table size (i.e., number of data points) along x/y/z |
| EXT_POT_TABLE_NPOINT_Y                                       |              -1 |            None |            None |  |
| EXT_POT_TABLE_NPOINT_Z                                       |              -1 |            None |            None |  |
...
| Name                                                         |         Default |             Min |             Max | Description |
| :---                                                         |            :--- |            :--- |            :--- | :--- |
| GAMMA                                                        | 1.79769313e+308 |            None |            None | ratio of specific heats (i.e., adiabatic index) [5.0/3.0] ##EOS_GAMMA ONLY## |
...
| GRACKLE_CMB_FLOOR                                            |               1 |            None |            None | ... "cmb_temperature_floor" [1] |
| GRACKLE_COOLING                                              |               1 |            None |            None | ... "with_radiative_cooling" [1] |
| GRACKLE_H2_OPA_APPROX                                        |               0 |               0 |               1 | H2 opacity from Ripamonti+04; 0:off, 1:Ripomonti+04 |
| GRACKLE_METAL                                                |               0 |            None |            None | ... "metal_cooling" (must increase NCOMP_PASSIVE_USER by 1) [0] |
| GRACKLE_PE_HEATING                                           |               0 |            None |            None | ... "photoelectric_heating" [0] |
| GRACKLE_PE_HEATING_RATE                                      |         8.5e-26 |             0.0 |            None | ... "photoelectric_heating_rate (in erg/cm^3/s)" [8.5e-26] |
...
| GRACKLE_UV                                                   |               0 |            None |            None | ... "UVbackground" [0] |
...
| INT_OPP_SIGN_0TH_ORDER                                       |               0 |            None |            None | switch to 0th-order interpolation if adjacent values change signs [HYDRO:1; ELBDM:0] |
| ISO_TEMP                                                     | 1.79769313e+308 |            None |            None | isothermal temperature in kelvin ##EOS_ISOTHERMAL ONLY## |
...
| OPT__FIXUP_FLUX                                              |               1 |            None |            None | correct coarse grids by the fine-grid boundary fluxes [1] ##HYDRO and ELBDM ONLY## |
...
| OPT__OUTPUT_DIVMAG                                           |               0 |            None |            None | output |divergence(B)*dh/|B|| [0] ##MHD ONLY## |
...
| OPT__SORT_PATCH_BY_LBIDX                                     |               0 |            None |            None | sort patches to improve bitwise reproducibility [SERIAL:0, LOAD_BALACNE:1] |
...
| OPT__UM_IC_NVAR                                              |              -1 |            None |     NCOMP_TOTAL | number of variables in UM_IC: (1~NCOMP_TOTAL; <=0=auto) [HYDRO=5+passive/ELBDM=2] |
